...
public class FakeExecutionContext : TestExecutionContext
{
    ...
    public override AzureCloud Azure() =>
        new(_arm, new FakeAppService(_arm), new FakeFunctionService(_arm), new FakeContainerAppService(_arm), new FakeManagedIdentityService(), _keyVault, new FakeStorageService(), new FakeAppServicePlanService(), new FakeApplicationInsightsService(), new FakeDocker(_arm), _regions);
